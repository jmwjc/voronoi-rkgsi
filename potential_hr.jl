...
set𝝭!(elements["Γᵗ"])
set𝝭!(elements["Γ̃ᵍ"])
set∇̃𝝭!(elements["Γ̃ᵍ"],elements["Ω̃∩Γᵍ"],elements["Ω∩Γᵍ"])
set∇̄𝝭!(elements["Γ̃ᵍ"])

# cc = check∇₂𝝭(elements["Γ̃ᵍ"])
